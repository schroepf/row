...
interface AuthRepository {
    ...
    /**
     *  The current [de.mistatee.erglog.data.concept2.auth.model.Session], or `null` if the Logbook Account holder is
     *  not authenticated.
     */
     ...
     * about to expire. Fails with [de.mistatee.erglog.data.concept2.auth.model.SessionError.NoSession] if the Logbook
     * Account holder isn't authenticated, or [de.mistatee.erglog.data.concept2.auth.model.SessionError.RefreshFailed]
